...
def stu(sleeptime=60):
    ...
    while True:
        ...
        qtu = """INSERT INTO trip_updates (tu_id, start_time, start_date, trip_id, route_id, direction_id, schedule)
            VALUES (%s, %s, %s, %s, %s, %s, %s) ON CONFLICT DO NOTHING"""
                
        qstu = """INSERT INTO stop_time_updates (time, departure_time, stop_sequence, trip_id, stop_id, arrival_delay, departure_delay, tu_id)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT DO NOTHING"""
...
def tstu(sleeptime=60):
    ...
    while True:
        ...
        qtu = """INSERT INTO train_updates (tu_id, start_time, start_date, trip_id, route_id, direction_id, schedule)
            VALUES (%s, %s, %s, %s, %s, %s, %s) ON CONFLICT DO NOTHING"""
                
        qstu = """INSERT INTO train_stop_time_updates (time, departure_time, stop_sequence, trip_id, stop_id, arrival_delay, departure_delay, tu_id)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT DO NOTHING"""
